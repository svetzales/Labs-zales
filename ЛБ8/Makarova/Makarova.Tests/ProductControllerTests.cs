...
namespace Yeroma.Tests
{
    ...
    {
        IFlowersService _flowersService;
        ...
        void SetupData()
        {
            ...
            _categoryService.GetCategoryListAsync().Returns(Task.FromResult(categoriesResponse))
            ;
            _flowersService = Substitute.For<IFlowersService>();
            ...
            var productResponse = new ResponseData<FlowersListModel<Flower>>();
            productResponse.Data = new FlowersListModel<Flower> { Items = flowers };
